...
INSERT INTO `HOADB`.`assets` (`asset_id`, `asset_name`, `asset_description`, `acquisition_date`, `forrent`, `asset_value`, `type_asset`, `status`, `loc_lattitude`, `loc_longiture`, `hoa_name`, `enclosing_asset`) VALUES (5006, 'Conference Room', 'Malaking Maritesan', '2002-02-02', 0, 100000, 'P', 'W', 101.435, 101.435, 'SJH', 5006);
